...
const Filters = () => {
  const{
    filters:{
      text,category,company,color,price,min_price,max_price,shapping
    },
    updateFilters,
    clearFilters,
    all_products,
        ...
        <div className="content">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="form-control">
              <input type="text" name="text" placeholder='search here' className='search-input'
            ...
            {/*company  end */}
              ...
              {/*colors end */}
               ...
               <div className="form-control">
                ...
                <input type="range" name='price' onChange={updateFilters} max={max_price} min={min_price} value={price} />
               </div>
                {/* price end */}
            ...
            {/* shipping start */}
                <div className="form-control shipping">
                  ...
                  <input type="checkbox" name="shipping" id='shipping' onChange={updateFilters} checked={shapping}/>
                </div>
           {/* shipping end */}
          </form>
